    ...
    <div className="w-full max-w-md bg-white rounded-lg shadow-lg flex flex-col h-screen md:h-96">
      <div className="p-4 border-b">
        <div className="flex justify-between items-center mb-4">
          ...
          >
            <MessageCircle size={20} style={{ color: "#6B3FBF" }} />
          </button>
        </div>
          ...
          <div className="divide-y">
            {sortedConversations.map((conversation) => (
              <div
                ...
                className="p-4 hover:bg-gray-50 cursor-pointer transition border-l-4 border-transparent hover:border-grape-600"
              >
                <div className="flex gap-3">
                  <div className="relative flex-shrink-0">
                    ...
                    {conversation.isOnline && (
                      <div className="absolute bottom-0 right-0 w-3 h-3 bg-grape-300 rounded-full border-2 border-white" />
                    )}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {conversation.unreadCount > 0 && (
                      <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                        <span className="inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white rounded-full" style={{ background: "#6B3FBF" }}>
