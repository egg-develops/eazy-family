...
import { Plus, Minus, Copy, RotateCw } from "lucide-react";
...
export function GradientGenerator() {
  ...
  const resetSettings = () => {
    ...
    toast({
      title: "Reset",
      description: "Gradient settings have been reset",
    });
  };
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap justify-center gap-6">
        <div className="relative">
          <div
            className="aspect-square h-full w-60 rounded-md"
            style={gradientStyle}
          ></div>
          <canvas
            ...
            width={1000}
            height={1000}
            className="absolute left-0 top-0 aspect-square h-full w-60 rounded-md mix-blend-overlay"
          />
        </div>
