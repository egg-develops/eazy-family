    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#FBF8FF", color: "#1A0B2E" }}>
      ...
      <main className="flex-1 max-w-5xl mx-auto px-5 pt-32 pb-16 space-y-20">
        ...
        <section className="text-center max-w-2xl mx-auto space-y-5">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-light tracking-tight" style={HEADING}>
        ...
        {/* Event types */}
        <section>
          <h2 className="font-serif text-xl font-light text-center mb-8" style={HEADING}>
            ...
            {eventTypes.map(e => {
              ...
              return (
                <div key={e.title} className="rounded-2xl p-5 text-center space-y-3" style={CARD}>
                  ...
                  <p className="text-xs leading-relaxed" style={SUBTLE}>{e.desc}</p>
                </div>
              );
            })}
          </div>
