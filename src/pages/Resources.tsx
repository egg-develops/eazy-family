...
const CARD    = { background: "#FFFFFF", border: "1px solid #EBE8E2" } as React.CSSProperties;

// ─── Badge colours ───────────────────────────────────────────
function badgeStyle(badge: string): React.CSSProperties {
  switch (badge) {
    case "Top Pick":        return { background: "#964735", color: "#FDF9F3" };
    case "Editor's Choice": return { background: "#1C1C18", color: "#FDF9F3" };
    case "Family Favourite":return { background: "#D97B66", color: "#FDF9F3" };
    case "Best Value":      return { background: "#7A6660", color: "#FDF9F3" };
    default:                return { background: "#EBE8E2", color: "#964735" };
  }
}
  ...
  return (
    <div style={{ backgroundColor: "#FDF9F3", minHeight: "100vh" }}>
      ...
      <main className="max-w-5xl mx-auto px-5 pt-32 pb-20 space-y-16">
          ...
          {(["blog", "parenting", "shop"] as const).map((section) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Icon className="w-5 h-5" style={{ color: "#964735" }} />
                </div>
                <div>
        ...
        <section id="blog" className="space-y-6 scroll-mt-24">
          <div className="flex items-center gap-2">
            <Rss className="w-5 h-5" style={{ color: "#964735" }} />
              ...
              return (
                ...
                >
                  ...
                  <span
                    ...
                    style={{ background: "#EBE8E2", color: "#964735" }}
                  >
                    {post.tag}
                  </span>
                  ...
                  {isOpen && (
                    <div
                      ...
                      style={{ borderColor: "#EBE8E2", color: "#964735" }}
                    >
        ...
        <section id="parenting" className="space-y-6 scroll-mt-24">
          <div className="flex items-center gap-2">
            <Heart className="w-5 h-5" style={{ color: "#D97B66" }} />
            <h2 className="font-serif text-2xl" style={HEADING}>
            ...
            {parentingArts.map((article) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className="inline-block text-xs px-2 py-0.5 rounded-full font-medium"
                    style={{ background: "#F7F3ED", color: "#D97B66" }}
                  >
                    {article.tag}
                  </span>
                  ...
                  {isOpen && (
                    <div
                      className="pt-3 border-t text-xs leading-relaxed"
                      style={{ borderColor: "#F7F3ED", color: "#964735" }}
                    >
        ...
        <section id="shop" className="space-y-8 scroll-mt-24">
          <div className="flex items-start justify-between flex-wrap gap-3">
            <div className="flex items-center gap-2">
              <ShoppingBag className="w-5 h-5" style={{ color: "#964735" }} />
              <h2 className="font-serif text-2xl" style={HEADING}>
                {SECTION_LABELS.shop[lang]}
              </h2>
            </div>
            <p className="text-xs max-w-sm leading-relaxed" style={{ color: "#DAC1BB" }}>
                ...
                {cat.items.map((product) => (
                  ...
                  >
                    ...
                    <a
                      ...
                      style={{ background: "#964735", color: "#FDF9F3" }}
                    >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {isOpen ? (
                      <ChevronUp className="w-4 h-4 flex-shrink-0" style={{ color: "#964735" }} />
                    ) : (
                      <ChevronDown className="w-4 h-4 flex-shrink-0" style={{ color: "#964735" }} />
                    )}
                  </button>
                  {isOpen && (
                    <div
        ...
        >
          <h2 className="font-serif text-2xl sm:text-3xl" style={{ color: "#FDF9F3" }}>
            Ready to make your family life Eazy?
          </h2>
          <p className="text-sm leading-relaxed max-w-md mx-auto" style={{ color: "#DAC1BB" }}>
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <Button
              ...
              style={{ background: "#FDF9F3", color: "#964735" }}
            >
              Get started free
      ...
      <footer
        ...
        style={{ borderColor: "#EBE8E2", background: "#FDF9F3" }}
      >
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs" style={{ color: "#DAC1BB" }}>
